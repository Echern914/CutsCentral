...
> The product name lives in one constant: `packages/config/src/constants.ts → APP_NAME`.
...
4. Barbers click **Connect Acuity** in onboarding → consent → we store an (encrypted) token,
