...
export const FEATURE_INDEX: FeatureIndexEntry[] = [
  ...
  },
  {
    ...
    description: "Ask for what you can't start the job without - an address, a vehicle, a request",
    href: "/dashboard/booking?tab=Settings",
    category: "booking",
    questions: [
      "how do I get more information when someone books",
      "can I ask for an address at booking",
